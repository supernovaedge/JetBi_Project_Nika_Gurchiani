...
* @Description  This is CSV file uploader and LWC datatable with actions for JETBI Project
*******************************************************************************************/

import { LightningElement, api, track, wire } from 'lwc';
import uploadFileClass from '@salesforce/apex/fileUploadController.uploadFile';
import getSensors from '@salesforce/apex/fileUploadController.getSensors';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
import { deleteRecord } from 'lightning/uiRecordApi';
import { refreshApex } from "@salesforce/apex";
import getMetadata from '@salesforce/apex/fileUploadController.getCustomMetadata';
...
export default class FileUploaderLWC extends LightningElement {
    ...
    wiredSensors;
    totalRecords = 0;
    totalPages;  //This is total number of the pages. 
    startingPoint = 0;
    pageNumber = 1;
